...
$getmarkets1 = $con->prepare("SELECT name, userid, requestid, datenow, hashtag1, hashtag2, hashtag3, hashtag4, hashtag5 FROM requests WHERE (name LIKE '%".$filterValue."%' OR hashtag1 LIKE '%".$filterValue."%'
