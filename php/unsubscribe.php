...
// a:4:{i:0;s:2:"12";i:1;s:2:"22";i:2;s:5:"e-b22";i:3;s:5:"e-b22";}
$index = array_search($marketid, array_values($subscriptions_arr));
print json_encode($index);
array_splice($subscriptions_arr, $index, 1);
$subscriptions_str = serialize($subscriptions_arr);

$uploadmarket = $con->prepare("UPDATE signup SET subscriptions = '{$subscriptions_str}' WHERE userid = '{$userid}'");
